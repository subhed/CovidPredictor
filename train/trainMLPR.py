...
if __name__== "__main__":
    ...
    mlp = MLPRegressor(hidden_layer_sizes=(100,100,100), max_iter=500, alpha=0.0001,solver='sgd',random_state=0).fit(X_train, Y_train) 
    mlp.fit(X_train, Y_train)


    file = open('model/modelMLPR.pkl','wb')
